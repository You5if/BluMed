...
import com.component.pharma.databinding.FragmentFirstScreenBinding
...
class FirstScreenFragment : BaseFragment<AuthViewModel, FragmentFirstScreenBinding, AuthRepository>() {

...
class UploadRequestBody(
        ...
        private val callback: UploadFragment,
        private val callback2: ThirdNavFragment,
): RequestBody() {
    ...
    inner class ProgressUpdate2(
            private val uploaded: Long,
            private val total: Long
    ) : Runnable {
        override fun run() {
            callback2.onProgressUpdate((100 * uploaded / total).toInt())
        }
    }
